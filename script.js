function transferDataToInvoice(invoiceId, cartId) {
    if (document.getElementById(cartId).value){
        // console.log(document.getElementById(invoiceId).value);
        console.log(document.getElementById(cartId).value);
        document.getElementById(invoiceId).innerText = document.getElementById(cartId).value;
    }
    else
...
confirmBtn.addEventListener('click', function () {
    ...
    //Transfer Customer Details From Customer Info
    transferDataToInvoice('display-name','exampleInputName');
    transferDataToInvoice('display-email','exampleInputEmail1');
    transferDataToInvoice('display-phone','exampleInputPhone');
    transferDataToInvoice('display-address','exampleInputPresentAddress');

    //transfer Item Details from Cart
    transferDataToInvoice('invoice-item1-name', 'itemName1');
    transferDataToInvoice('invoice-item2-name', 'itemName2');
    transferDataToInvoice('invoice-item1-price', 'price1');
    transferDataToInvoice('invoice-item2-price', 'price2');
    transferDataToInvoice('invoice-item1-quantity', 'quantityOfItem1');
    transferDataToInvoice('invoice-item2-quantity', 'quantityOfItem2');
    transferDataToInvoice('invoice-item1-total', 'price1');
    transferDataToInvoice('invoice-item2-total', 'price2');
    transferDataToInvoice('invoice-subtotal', 'subtotal');
    transferDataToInvoice('invoice-total', 'total');
    transferDataToInvoice('invoice-tax', 'tax');
})
